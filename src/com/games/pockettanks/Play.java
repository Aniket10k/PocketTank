...
public class Play extends JFrame implements KeyListener {
	...
	public Play(String p, String q) throws Exception {
		...
		String soundName = "sound/d.wav";
		String sound2 = "sound/sound1.wav";
		...
		img1 = ImageIO.read(new File("images/tankfinal.png"));
		img2 = ImageIO.read(new File("images/tankfinal2.png"));
		img3 = ImageIO.read(new File("images/finalgun1.png"));
		img4 = ImageIO.read(new File("images/finalgun2.png"));
		img5 = ImageIO.read(new File("images/finalground1.png"));
		img6 = ImageIO.read(new File("images/hill.png"));
		img7 = ImageIO.read(new File("images/back4.png"));
		addKeyListener(this);
